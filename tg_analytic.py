...
def custom(app):
    ...
    return f"""
– Количество групп {count_chats}
– Количество сообщений обработанных {numbers_messages}
– Количество кольков: пользователей в боте, без бота {count_write_to_bot}/{count_no_write_to_bot}
– Количество лайкодействий {like_messages}
– Количество  переведенных лайков {sended_counts}
    """